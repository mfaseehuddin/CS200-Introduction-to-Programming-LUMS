...
int main()
{
    ...
    // testing vector, as stack
    // Normal Cases for pop, and push, without crossing the initial capacity of SIZE=10
    cout << "Pushing on stack - simple values - normal case" << endl;
    for (int i = 0; i < 5; i++)
    {
        cout << "Pushing: " << i << " ";
        v1.push(i);
    ...
    cout << "Popping from stack - in range - normal case" << endl;
    for (int i = 0; i < 5; i++)
    {
        cout << "Popped: " << v1.pop() << " ";
        v1.printVector();
    }
    // EXTRANEOUS Cases for stack pop
    cout << "trying to pop from an empty stack -- EXTRANEOUS CASE -- REQUIRES EXCEPTION HANDLING" << endl;
    try
    {
        v1.pop();
    }
    ...
    Vector v2;
    int numberOfItemsToAdd = 20;
    // KHULA EZ HOKE TRY CATCH FULL SPEED
    try
    {
        ...
        for (int i = 0; i < numberOfItemsToAdd + 1; i++)
        {
            v2.pop();
        }
    }
    ...
    */
    ...
    cout << "CHANGE TYPE TO QUEUE" << endl; 
    v3.changeType('q');
    for (int i = steps; i < steps + steps; i++)
    {
        cout << "Pushing: " << i << " ";
        v3.push(i);
        v3.printVector();
    }
    cout << "CHANGE TYPE TO STACK" << endl;
    v3.changeType('s');
    for (int i = 0; i < steps; i++)
    {
        cout << "Popped:  " << v3.pop() << " ";
