...
int FactorialRecursion(int inputNum);
...
int main()
{
    ...
    cout << endl;
    cout << "factorial: " << FactorialRecursion(5) << endl;
    return 0;
}
...
// input an integer and print reversed
    ...
    void reverseIntegerRecursive(int currNum)
    {
        ...
        //call stack for the reverseIntegerRecursive function
        //|---------------|
        //|r = 0          |
...
int FactorialRecursion(int inputNum)
{
    if (inputNum == 1)
        return 1;
    return inputNum * FactorialRecursion(inputNum - 1);
}